...
public class Salesforce {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(line +"\r\nShawn Peng\r\nlankeypeng@outlook.com\r\n" + line + "\r\nOnly effective on Baofoo deposit case which generated by the system\r\n暂仅对系统自动生成的宝付case有效\r\n" + line);
...
//			salesforce.editDepositCase(new HashMap<String, String>(20));
	 ...
	 * @throws IOException
	 */
	public boolean login(String un, String pw) throws IOException {
...
//		System.out.println(line);
		if (text.contains("gmi.my.salesforce.com/home/home.jsp")) {
			System.out.println("登录成功！\r\n" + line);
			return true;
		}else{
			System.out.println("登录失败，请检查用户名密码后关闭程序重试。\r\n" + line);
			return false;
		}
...
//			String cookie;
			...
			String entityId;
			String caseUrl;
			entityId = readInputLine("请键入case 网址，如: https://gmi.my.salesforce.com/5006F00001IA7KE");
			entityId = entityId.replaceAll("https://gmi.my.salesforce.com/", "");
...
//					.split("&", 2)[0];
			...
			System.out.println("Case修改完成，请检查，并手动设置该case的拥有者(入金账户)\r\n" + line);
